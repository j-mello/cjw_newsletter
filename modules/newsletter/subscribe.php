...
$recaptcha = new CjwNewsletterRecaptcha();
...
if ( $module->isCurrentAction( 'Subscribe' ) ) {
    ...
    if ($recaptcha->validate() || $recaptcha->hasHandler() == false) {
        ...
        $messageArray['list_array'] = array(
            'field_key' => ezpI18n::tr('cjw_newsletter/subscription', 'Newsletter'),
            'message' => ezpI18n::tr('cjw_newsletter/subscription', 'You must choose a list for subscription.')
        );
        $messageArray['first_name'] = array(
            'field_key' => ezpI18n::tr('cjw_newsletter/subscription', 'First name'),
            'message' => ezpI18n::tr('cjw_newsletter/subscription', 'You must enter a first name.')
        );
        $messageArray['last_name'] = array(
            'field_key' => ezpI18n::tr('cjw_newsletter/subscription', 'Last name'),
            'message' => ezpI18n::tr('cjw_newsletter/subscription', 'You must enter a last name.')
        );
        $messageArray['email'] = array(
            'field_key' => ezpI18n::tr('cjw_newsletter/subscription', 'Email'),
        ...
        $warningArr['recaptcha'] = array(
            'field_key' => ezpI18n::tr('cjw_newsletter/subscription', 'Antispam'),
            'message' => ezpI18n::tr('cjw_newsletter/subscription', 'You must fill the recaptcha.')
        );
    }
}
